...
if(ENVIRONMENT=="production"){
	...
	$config['base_url'] = 'https://sked.com.br';

}

elseif (ENVIRONMENT=="development") {

	$config['base_url'] = 'http://localhost/freelas/elcione';
...
|
*/
$config['encryption_key'] = 'gutoNelosAdmOamorDeDeusEmeuTesouro';
...
*/
$config['proxy_ips'] = array('54.94.183.101', '52.67.12.206');
